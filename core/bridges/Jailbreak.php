    ...
    */
    public function getAllElements(){
        ...
        foreach ($eqLogics as $eqLogic) {    
            ...
            if(!empty($eqLogic->getConfiguration('Modele'))){
                $return[$eqLogic->getId()]["plugin_print"] = self::$plug . " :: " . $eqLogic->getConfiguration('Modele');
            } else {
