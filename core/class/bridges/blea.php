...
class scan_ip_blea {
    ...
    */
    public static $plug = "blea";
    public static $name = "Antenne";
    public static $ip = "remoteIp";
    ...
    */
    public function getAllElements(){
        ...
        foreach ($eqLogics as $eqLogic) {    
            ...
            $return[$eqLogic->getId()]["plugin_print"] = self::$plug . " :: " . self::$name;
            $return[$eqLogic->getId()]["name"] = $eqLogic->getRemoteName();
        ...
        foreach ($eqLogics as $eqLogic) {
            if ($eqLogic->getId() == $_array["id"]) { 
                if($eqLogic->getConfiguration(self::$ip) != $_array["ip"]){
                    ...
                    blea::launchremote($eqLogic->getId());
                    return NULL;
                }   
            }
        }
