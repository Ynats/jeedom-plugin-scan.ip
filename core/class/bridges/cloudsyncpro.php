    ...
    */
    public function getAllElements(){
        ...
        foreach ($eqLogics as $eqLogic) {    
            ...
            if ($eqLogic->getConfiguration('type') == 'ftp' || $eqLogic->getConfiguration('type') == 'sftp') {
