    ...
    */
    public function getAllElements(){
        ...
        foreach ($eqLogics as $eqLogic) {  
            // Certains équipements ne sont pas compatible LAN, donc IP vide, on skip
