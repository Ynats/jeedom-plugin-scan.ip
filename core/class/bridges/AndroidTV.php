    ...
    */
    public function getAllElements(){
        ...
        foreach ($eqLogics as $eqLogic) {
            if ($eqLogic->getConfiguration('type_connection') == 'USB') continue;

            $return[$eqLogic->getId()]["plugin"] = self::$plug;
            $return[$eqLogic->getId()]["plugin_print"] = self::$plug . " :: " . $eqLogic->getConfiguration('type_connection');
